        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button on:click={closeDialog} class="text-gray-500 hover:text-gray-700" aria-label="Close dialog">
                ...
                {:else}
                    ...
                    <div class="mb-6">
                        <label for="targetBranch" class="block text-sm font-medium text-gray-700 mb-2">Target Branch</label>
                        <select
                            id="targetBranch"
